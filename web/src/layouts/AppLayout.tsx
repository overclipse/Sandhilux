      ...
      <aside className={`${styles.sidebar} ${collapsed ? styles.collapsed : ''}`}>
        ...
        <nav className={styles.nav}>
          <NavLink to="/" end className={navClass} data-tooltip={t('nav.dashboard')}>
            <svg className={styles.navSvg} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className={styles.controls}>
          ...
          >
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" style={collapsed ? { transform: 'rotate(180deg)' } : undefined}>
        ...
        <div className={styles.userSection}>
          ...
          <button className={styles.logoutBtn} onClick={logout} title={t('nav.signOut')}>
